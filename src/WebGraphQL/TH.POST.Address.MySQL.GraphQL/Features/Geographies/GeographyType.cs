...
namespace TH.POST.Address.MySQL.GraphQL.Features.Geographies
{
    public class GeographyType : ObjectType<GeographyEntity>
    {
        ...
        {
            public IQueryable<ProvinceEntity> GetProvinces(GeographyEntity geography, [ScopedService] AppMySQLContext context)
            {
