...
namespace TH.POST.Address.SQLServer.GraphQL.Features.Geographies
{
    public class GeographyType : ObjectType<GeographyEntity>
    {
        ...
        {
            public IQueryable<ProvinceEntity> GetProvinces(GeographyEntity geography, [ScopedService] AppSQLServerContext context)
            {
