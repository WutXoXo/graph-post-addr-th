...
namespace TH.POST.Address.SQLServer.GraphQL.Features.Districts
{
    public class DistrictType : ObjectType<DistrictEntity>
    {
        ...
        {
            public AmphurEntity GetAmphur(DistrictEntity district, [ScopedService] AppSQLServerContext context)
            {
