...
namespace TH.POST.Address.PostgreSQL.GraphQL.Features.Provinces
{
    public class ProvinceType : ObjectType<ProvinceEntity>
    {
        ...
        protected override void Configure(IObjectTypeDescriptor<ProvinceEntity> descriptor)
        {
            ...
            descriptor
                ...
                .UseDbContext<AppPostgreSQLContext>()
        ...
        {
            public GeographyEntity GetGeography(ProvinceEntity province, [ScopedService] AppPostgreSQLContext context)
            {
                return context.Geographies.FirstOrDefault(p => p.Id == province.GeographyId);
            }

            public IQueryable<AmphurEntity> GetAmphures(ProvinceEntity province, [ScopedService] AppPostgreSQLContext context)
            {
