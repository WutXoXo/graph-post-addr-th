...
namespace TH.POST.Address.PostgreSQL.GraphQL.Features.Districts
{
    public class DistrictType : ObjectType<DistrictEntity>
    {
        ...
        {
            public AmphurEntity GetAmphur(DistrictEntity district, [ScopedService] AppPostgreSQLContext context)
            {
