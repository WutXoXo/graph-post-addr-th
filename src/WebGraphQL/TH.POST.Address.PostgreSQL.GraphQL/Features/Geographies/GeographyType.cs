...
namespace TH.POST.Address.PostgreSQL.GraphQL.Features.Geographies
{
    public class GeographyType : ObjectType<GeographyEntity>
    {
        ...
        {
            public IQueryable<ProvinceEntity> GetProvinces(GeographyEntity geography, [ScopedService] AppPostgreSQLContext context)
            {
